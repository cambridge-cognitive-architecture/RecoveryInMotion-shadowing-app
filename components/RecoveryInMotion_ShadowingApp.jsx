...
function FloorplanCanvas({ imageUrl, zones, drawingMode=false, draftPoints=[], hoverPoint=null, onCanvasClick, onCanvasMouseMove, onCanvasMouseLeave, events=[], markers=[], pendingPos=null, height=480 }) {
  ...
  return (
    <canvas ref={canvasRef} width={1000} height={600}
      ...
      style={{ width:"100%", height:"auto", borderRadius:10, display:"block", cursor:"crosshair" }}
    />
  );
}
    ...
    <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 380px", gap:24 }}>
        ...
        <div>
          ...
          <div style={{ border:"2px solid " + (drawingZone ? "#F59E0B" : "#E2E8F0"), borderRadius:12, overflow:"hidden", lineHeight:0 }}>
            <FloorplanCanvas
