  ...
  return (
    ...
    <div style={{ display: "grid", gridTemplateColumns: "1fr 360px", height: "100%", overflow: "hidden" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "white", overflow: "hidden" }}>
        ...
        {/* ── PINNED BOTTOM BAR: counts left · timer+undo right ── */}
        <div style={{ flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "space-between",
          padding: "7px 10px", borderTop: "1.5px solid #F1F5F9", gap: 8, background: "white" }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
            {counts.map(s => (
              <div key={s.label} style={{ display: "flex", alignItems: "baseline", gap: 3 }}>
                ...
                <span style={{ fontSize: 8, textTransform: "uppercase", letterSpacing: "0.07em",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0,
            ...
            borderRadius: 7, padding: "5px 10px", transition: "all 0.2s" }}>
            ...
            <span style={{ fontSize: 17, fontWeight: 800, fontFamily: "'DM Mono',monospace",
              color: activeEv ? "#1E293B" : "#CBD5E1", letterSpacing: "-0.02em", minWidth: 46 }}>
              {formatElapsed(elapsed)}
            </span>
            {activeEv
              ? <span style={{ fontSize: 9, fontWeight: 700, maxWidth: 140, overflow: "hidden",
              ...
              : <span style={{ fontSize: 10, color: "#CBD5E1", fontFamily: "'DM Sans',sans-serif" }}>No active event</span>
            }
            {lastAction && (
              <button onClick={undoLast}
                style={{ flexShrink: 0, padding: "2px 7px", border: "1.5px solid #E2E8F0", borderRadius: 5,
  ...
  return (
    <div style={{ height:"100dvh", overflow:"hidden", background:"#F0F4F8" }}>
      ...
      {(tab==="setup" || tab==="review") && (
        <div style={{ height:"calc(100dvh - var(--nav-h, 52px))", overflowY:"auto", padding:"18px 22px" }}>
